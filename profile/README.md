...
- **Slogan:** Building Science-Driven and Intelligent Machines
- **Goal:** Based on **open-source custom chips** to build **open-source machine systems** for the future era, helping humans solve some of the challenges encountered in real life.
